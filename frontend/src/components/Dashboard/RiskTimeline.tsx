        ...
        {chartData.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
              ...
              <XAxis
                dataKey="time"
                tick={{ fill: '#556680', fontSize: 10, fontFamily: 'JetBrains Mono' }}
                axisLine={{ stroke: 'rgba(100, 160, 255, 0.1)' }}
                tickLine={false}
              ...
              <Tooltip
                ...
                labelStyle={{ color: '#8899b4', fontSize: 11 }}
                formatter={(value: number, name: string) => {
                  if (name === 'risk') return [`${value}`, 'Max Risk Score'];
                  return [`${value}`, 'Events'];
                }}
              />
              <Area
